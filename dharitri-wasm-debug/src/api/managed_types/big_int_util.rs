...
use dharitri_wasm::types::{ManagedBuffer, ManagedType};
use num_bigint::Sign;
use num_traits::Zero;
...
impl DebugApi {
    ...
    pub fn insert_new_big_uint_zero(&self) -> dharitri_wasm::types::BigUint<Self> {
        self.insert_new_big_uint(num_bigint::BigUint::zero())
    }

    pub fn big_uint_value(&self, bu: &dharitri_wasm::types::BigUint<Self>) -> num_bigint::BigUint {

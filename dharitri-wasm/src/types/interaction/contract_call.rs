use crate::{
    api::{
        SendApi, DCT_MULTI_TRANSFER_FUNC_NAME, DCT_NFT_TRANSFER_FUNC_NAME,
    ...
    SA: SendApi + 'static,
{
    ...
    ContractCall::<SA, R>::new_with_dct_payment(api, to, endpoint_name, payments)
}
    ...
    SA: SendApi + 'static,
{
    pub fn new(api: SA, to: ManagedAddress<SA>, endpoint_name: ManagedBuffer<SA>) -> Self {
        ...
        Self::new_with_dct_payment(api, to, endpoint_name, payments)
    }
